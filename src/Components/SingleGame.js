        ...
        switch (this.props.isFetching) {
            ...
            case "LOADED":
                ...
                gameDetails = ( <
                        ...
                        this.props.game.summary && < p > { this.props.game.summary } < /p>} <
                            ...
                            h2 > RATE: < /h2> {
                                this.props.game.rating && ( <
                                    p className = "game-popularity" > { this.props.game.rating.toFixed(2) } <
                                    /p>
                                )
                            } <
                            /Col> <
                    ...
                    break;
                    default:
                    gameDetails = < b > Failed to load data, please
                    try again < /b>;
                    break;
                }
                ...
                return ( <
                    ...
                    Back to Search <
                    /Link> <
                    div className = "game-content" > { /* <h1 className="single-game-title">this is game: {this.state.currentId}</h1> */ } {
